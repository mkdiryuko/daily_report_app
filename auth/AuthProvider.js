...
class AuthProvider {
  ...
  login(options = {}) {
    return async (req, res, next) => {
       ...
       * MSAL Node ライブラリを使用すると、カスタム状態を Request オブジェクトの state パラメーターとして渡すことができます。
       * state パラメーターは、リダイレクト前にアプリの状態の情報をエンコードするためにも使用できます。
       * アプリ内のユーザーの状態 (ユーザーが表示していたページやビューなど) を、このパラメーターへの入力として渡すことができます。
       */
